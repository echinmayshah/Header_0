...
/*********Rate Limiters*********/
#define MOTOR_CTRL_SPEED_CMD_RATE                  5.0f //c (1000.0f)                    /*[RPM/sec], Speed command rate*/
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
#define MOTOR_CTRL_CURRENT_CMD_RATE                (0.5f*MOTOR_CURRENT_PEAK) //c (10.0f*MOTOR_CURRENT_PEAK)   /*[A/sec], Current command rate*/
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW                      75.0f //c (750.0f)                      /*[Hz], Current loop bandwidth*/
